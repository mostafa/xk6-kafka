...
0. Setup your [CGO Environment](https://github.com/go101/go101/wiki/CGO-Environment-Setup#use-gcc)
1. Install tools with `mise install`
2. Start local development services with `mise run services` (keep this terminal running)
3. Hack with your editor
4. Build with `mise run build`
5. Run unit tests with `mise run test`
6. Test your binary with `./k6 <path to test script>`
7. Repeat 3-6 until you are satisfied
8. Format your files with `mise run format`
9. Verify with `mise run verify`
